...
const MAPPING = {
  ...
  'credit-card.outlined': CreditCardOutlineIcon,
  'document-text.outlined': DocumentTextOutlineIcon,
  'document.outlined': DocumentOutlineIcon,
  'ellipsis-vertical.outlined': EllipsisVerticalOutlineIcon,
  'identification.outlined': IdentificationOutlineIcon,
  ...
  'qr-code.outlined': QrCodeOutlineIcon,
